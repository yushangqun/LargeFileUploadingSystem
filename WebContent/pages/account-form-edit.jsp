...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a
					href="${pageContext.request.contextPath}/list.html">Home</a></li>
	...
	<div id="container">
		...
		<form:form action="submitEditedAccounte.html" modelAttribute="sysUser"
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input type="text" path="account" class="form-control" readonly="true" />
				</div>
			</div>
